...
import com.tjyw.bbbzqm.fragment.PayPackageEntryFragment;
import com.tjyw.bbbzqm.fragment.PayServiceFragment;
...
//                set.start();
    ...
    public void postOnNamingSuccess(RNameDefinition result) {
        ...
        nameTabHost.setupWithViewPager(nameMasterContainer);
    }
