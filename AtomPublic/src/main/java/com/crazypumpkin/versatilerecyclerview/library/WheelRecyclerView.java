...
public class WheelRecyclerView extends RecyclerView {
    ...
    private final int DEFAULT_UNSELECT_TEXT_COLOR = getResources().getColor(android.R.color.black);
    ...
    private class WheelAdapter extends Adapter<WheelAdapter.WheelHolder> {
        ...
        public WheelHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            WheelHolder holder = new WheelHolder(LayoutInflater.from(getContext()).inflate(R.layout.atom_pub_wheel_item, parent, false));
    ...
    public interface OnSelectListener {
        ...
        void onSelect(WheelRecyclerView recyclerView, int position, String data);
    }
